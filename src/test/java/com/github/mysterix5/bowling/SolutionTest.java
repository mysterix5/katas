...
public class SolutionTest {
    ...
    public void test_XX0() {
        assertEquals(30, Solution.bowling_score("X X 00 00 00 00 00 00 00 00"));
    }
    @Test
    public void test_XX42() {
        assertEquals(46, Solution.bowling_score("X X 42 00 00 00 00 00 00 00"));
    }
    @Test
    ...
    public void test_0XXXX() {
        assertEquals(60, Solution.bowling_score("00 00 00 00 00 00 00 00 X XXX"));
    }

    @Test
    public void test_arghssss(){
        assertEquals(150, Solution.bowling_score("5/ 4/ 3/ 2/ 1/ 0/ X 9/ 4/ 8/8"));
    }
    @Test
    public void test_arghssss2(){
        assertEquals(124, Solution.bowling_score("5/ 4/ 3/ 2/ 1/ 0/ X 9/ 4/ 00"));
    }
}